...
pig -f /home/weichi/hw1/web.pig -param m=10000000 -param n=20 -param domain='.*' -param time_start=$time_start_1
...
hbase shell /home/weichi/hw1/cmd.txt
rm /home/weichi/hw1/cmd.txt

# #2
# recent M days, top N domains, filter specific domains
time_start_2=$(date "+%s%3N")
pig -f /home/weichi/hw1/web2.pig -param m=10000000 -param n=20 -param domain='.*yahoo.*' -param time_start=$time_start_2
time_end_2=$(date "+%s%3N")
#echo "time_start_2: $time_start_2"
#echo "time_end_2: $time_end_2"

node /home/weichi/hw1/thrift/command.js put RDBPHistory $time_start_2 cf BP2 $time_end_2
...
pig -f /home/weichi/hw1/product.pig -param m=10000000 -param n=20 -param domain='.*' -param time_start=$time_start_3
time_end_3=$(date "+%s%3N")
#echo "time_start_3: $time_start_3"
#echo "time_end_3: $time_end_3"

node /home/weichi/hw1/thrift/command.js put RDBPHistory $time_start_3 cf BP3 $time_end_3
...
pig -f /home/weichi/hw1/product2.pig -param m=10000000 -param n=20 -param domain='.*' -param time_start=$time_start_4
time_end_4=$(date "+%s%3N")
#echo "time_start_4: $time_start_4"
#echo "time_end_4: $time_end_4"

node /home/weichi/hw1/thrift/command.js put RDBPHistory $time_start_4 cf BP4 $time_end_4
...
pig -f /home/weichi/hw1/product3.pig -param m=10000000 -param n=20 -param domain='.*' -param time_start=$time_start_5
time_end_5=$(date "+%s%3N")
#echo "time_start_5: $time_start_5"
#echo "time_end_5: $time_end_5"

node /home/weichi/hw1/thrift/command.js put RDBPHistory $time_start_5 cf BP5 $time_end_5
