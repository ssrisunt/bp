...
pig -f web2.pig -param m=10000000 -param n=20 -param domain='.*yahoo.*' -param time_start=$time_start_2
...
pig -f product.pig -param m=10000000 -param n=20 -param domain='.*' -param time_start=$time_start_3
...
pig -f product2.pig -param m=10000000 -param n=20 -param domain='.*' -param time_start=$time_start_4
...
pig -f product3.pig -param m=10000000 -param n=20 -param domain='.*' -param time_start=$time_start_5
